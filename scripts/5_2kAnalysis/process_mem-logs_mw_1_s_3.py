...
output:
- mw_1_s_3_mem_tp.csv: throughput for read and write loads
- mw_1_s_3_mem_rt.csv: response time for read and write loads
...
if __name__ == "__main__":
    ...
    tp_file = open("processed_data/{}/mw_1_s_3_mem_tp.csv".format(date), "w") # throughput
    rt_file  = open("processed_data/{}/mw_1_s_3_mem_rt.csv".format(date), "w") # response-time
