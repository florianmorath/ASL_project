...
output:
- mw_2_s_3_mem_tp.csv: throughput for read and write loads
- mw_2_s_3_mem_rt.csv: response time for read and write loads
...
if __name__ == "__main__":
    ...
    rt_file  = open("processed_data/{}/mw_2_s_3_mem_rt.csv".format(date), "w") # response-time
